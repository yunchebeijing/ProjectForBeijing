...
import com.ghl.login.entity.user.UserDepartment;
import com.ghl.login.entity.user.UserDepartmentExample;
...
public interface UserDepartmentMapper {
    ...
    @ResultMap("com.ghl.login.dao.user.UserDepartmentMapper.BaseResultMap")
